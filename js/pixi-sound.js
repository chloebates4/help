    ...
    var h = function() {
        ...
        g = {
            ...
            ReverbFilter: function(t) {
                function e(e, n, o) {
                    ...
                    var i = this;
                    if (!p().useLegacy)
                        return (i = t.call(this, null) || this)._seconds = i._clamp(e, 1, 50), i._decay = i._clamp(n, 0, 100), i._reverse = o, i._rebuild(), i;
        ...
        P = function(t) {
            ...
            return u(e, t), e.prototype.init = function(t) {
                ...
                if (4 !== e.readyState) {
                    if (!n.url)
                        return t(new Error("sound.url or sound.source must be set"));
                    e.src = n.url;
                    var o = function() {
